...
while True:
    ...
    if escolha_opcao_geral == '1':
        ...
        adicionar_produto_marca = input('Digite a marca do produto que deseja adicionar: ').upper().strip()
        adicionar_produto_codigo = input('Digite o código do produto que será adicionado: ').upper().strip()
    ...
    elif escolha_opcao_geral == '3':
        remover_produto_marca = input('Digite a marca do produto que deseja remover: ').upper().strip()
        remover_produto_codigo = input('Digite o código do produto que será removido: ').upper().strip()
        
        print(f'Marca digitada: {remover_produto_marca}')
        print(f'Código digitado: {remover_produto_codigo}')

        if remover_produto_marca == 'GALVANOTEK' or remover_produto_marca == 'G':
